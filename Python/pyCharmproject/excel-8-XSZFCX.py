...
import numpy as np
import os
df1 = pd.read_excel("F:\\AutoTest\\Python\\XSZFCX.xlsx") # 把excel内容读取为DataFrame对象
#print (df1)
#print "执行的excel中总共有%d列数据" %len(df1.columns)
#print "执行的excel中总共有%d行数据" %len(df1)
df2 = pd.read_excel("F:\\AutoTest\\Python\\lambor_Inputbox_XSZFCX.xlsx")
#print (df2)
...
time.sleep(3)
driver.get("http://backoffice.qc.lambor.ptg/Main/Finance/FinanceOnlinePayQuery/")
time.sleep(5)
driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[1]/div/div/div[2]/div/button[1]").click()
time.sleep(5)
...
for a in range(0,len(df2)):
    ...
    for index, word in enumerate(list(df1[inputbox_ID])): # 遍历df1中inputbox_ID下的所有值
        ...
        if word is np.nan:
            ...
            driver.find_element_by_xpath("//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[1]/label").click()
            time.sleep(1)  # 等待
            dd = driver.find_element_by_xpath(tips_ID).get_attribute("class")
            ee1 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[2]/a[1]').get_attribute("class")
            ee2 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[2]/a[2]').get_attribute("class")
            tips_ID_ee2 = '//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[2]/a[2]'

            ff1 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[6]/a[1]').get_attribute("class")
            ff2 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[6]/a[2]').get_attribute("class")
            tips_ID_ff2 = '//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[6]/a[2]'

            gg1 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[7]/a[1]').get_attribute("class")
            gg2 = driver.find_element_by_xpath('//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[7]/a[2]').get_attribute("class")
            tips_ID_gg2 = '//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[7]/a[2]'
            ...
            elif a == True and tips_ID == '//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[6]/a[1]' and ff1 == 'errorinfo ng-hide' and ff2 == 'errorinfo':
                result = driver.find_element_by_xpath(tips_ID_ff2).get_attribute("data-original-title")
            elif a == True and tips_ID == '//*[@id=\"myModal2\"]/div[2]/div/div[2]/form/div[7]/a[1]' and gg1 == 'errorinfo ng-hide' and gg2 == 'errorinfo':
                result = driver.find_element_by_xpath(tips_ID_gg2).get_attribute("data-original-title")
...
df1.to_excel("F:\\AutoTest\\Python\\OUTXSZFCX.xlsx", index=False)  # 把df1另存为excel
