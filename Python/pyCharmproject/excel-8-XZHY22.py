...
for a in range(0, len(df2)):
    ...
    for index, word in enumerate(list(df1[inputbox_ID])):   # 遍历df1中inputbox_ID下的所有值
        ...
        if word is np.nan:
            ...
            if tips_ID == lw1:
                try:
                    driver.find_element_by_xpath(tips_ID + Zd + Zd1)
                    driver.find_element_by_xpath(tips_ID + Z1)
                    driver.find_element_by_xpath(tips_ID + Z2)
                    a = True
                except:
                    a = False
                if a == False:
                ...
                elif a == True and tips_ID == lw1 and ddZd == '' and ddZ1 == cls1h and ddZ2 == cls2h:
                    result = driver.find_element_by_xpath(tips_ID + Zd + Zd1).get_attribute("data-original-title")
                    print ddZd
                    print ddZ1
                    print ddZ2
                    print result
                elif a == True and tips_ID == lw1 and ddZd == 'ng-hide' and ddZ1 == cls1 and ddZ2 == cls2h:
                    result = driver.find_element_by_xpath(tips_ID + Z1).text
                    print ddZd
                    print ddZ1
                    print ddZ2
                    print result
                elif a == True and tips_ID == lw1 and ddZd == 'ng-hide' and ddZ1 == cls1h and ddZ2 == cls2:
                ...
                #result = driver.find_element_by_xpath(tips_ID + S2).text
                    ...
                    try:
                        driver.find_element_by_xpath(tips_ID + Zd1)
                        a = True
                    except:
                        a = False
                    if a == False:
                    ...
                    # result = driver.find_element_by_xpath(tips_ID + S2).text
                        ...
                        result = driver.find_element_by_xpath(tips_ID + Zd1).get_attribute(
                            "data-original-title")  # 获取提示信息
                        print result
                    elif a == True and dd == 'ng-hide':
                        result = ""
                        print result
