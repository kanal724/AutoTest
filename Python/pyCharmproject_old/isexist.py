...
driver.get("https://passport.cnblogs.com/register.aspx?ReturnUrl=http://home.cnblogs.com")
...
# 判断页面上有无id为kw的元素
if is_element_exist("#Email-error"):
    print driver.find_element_by_id("Email-error").text
# 判断页面有无标签为input元素
